        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              <Link to="/" className="block text-gray-700 hover:text-blue-800 text-sm">
                Home
              </Link>
              <Link to="/about" className="block text-gray-700 hover:text-blue-800 text-sm">
                About Us
              </Link>
              <Link to="/products" className="block text-gray-700 hover:text-blue-800 text-sm">
                Products
              </Link>
              <Link to="/contact" className="block text-gray-700 hover:text-blue-800 text-sm">
                Contact
              </Link>
            </nav>
          </div>
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              <Link to="/industries" className="block text-gray-700 hover:text-blue-800 text-sm">
                Industries
              </Link>
              <Link to="/manufacturing" className="block text-gray-700 hover:text-blue-800 text-sm">
                Manufacturing
              </Link>
              <Link to="/certifications" className="block text-gray-700 hover:text-blue-800 text-sm">
                Certifications
              </Link>
            </nav>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center space-x-3 text-gray-700 hover:text-blue-800 text-sm"
              >
